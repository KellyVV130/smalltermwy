            ...
            <el-card style="background-color: whitesmoke; border: 0px;" shadow="never">
                ...
                <el-row>
                    ...
                    <el-col :span="8">
                        ...
                        <el-form-item>{{password}}</el-form-item>
                    ...
                    <el-col :span="2">
                        <el-form>
                            ...
                            <el-dialog title="修改昵称" :visible.sync="changeNameVisible" width="300px">
                            ...
                            <el-dialog title="修改密码" :visible.sync="changePasswordVisible" width="300px">
                            ...
                            <el-dialog title="修改手机号" :visible.sync="changePhoneVisible" width="300px">
                            ...
                            <el-dialog title="修改邮箱" :visible.sync="changeEmailVisible" width="300px">
